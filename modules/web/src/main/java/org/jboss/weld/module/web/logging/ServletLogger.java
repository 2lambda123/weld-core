...
public interface ServletLogger extends WeldLogger {
  ...
  ServletLogger LOG =
      Logger.getMessageLogger(ServletLogger.class, Category.SERVLET.getName());
  ...
  @Message(id = 708, value = "Initializing request {0}",
  ...
  @SuppressWarnings("weldlog:method-interface")
  @LogMessage(level = Level.TRACE)
  @Message(id = 709, value = "Destroying request {0}",
           format = Format.MESSAGE_FORMAT)
  void
  requestDestroyed(Object param1);

  @SuppressWarnings("weldlog:method-interface")
  @Message(id = 710, value = "Cannot inject {0} outside of a Servlet request",
           format = Format.MESSAGE_FORMAT)
  ...
  @Message(id = 712,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  unableToDissociateContext(Object context, Object storage);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  IllegalStateException
  cannotInjectServletContext(ClassLoader classLoader,
                             ServletContextService service);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  unableToDeactivateContext(Object context, Object request);

...
class Item implements Comparable<Item> {
  ...
  Class<?> getJavaClass() { return javaClass; }

  int getPriority() { return priority.get(); }
  ...
  public int compareTo(Item o) {
    ...
    if (p1 == p2) {
      /*
       * The spec does not specify what happens if two records have the same
       * priority. Instead of giving random results, we compare the records
       * based on their class name lexicographically.
       */

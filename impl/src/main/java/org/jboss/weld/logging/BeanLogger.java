...
public interface BeanLogger extends WeldLogger {
  ...
  BeanLogger LOG =
      Logger.getMessageLogger(BeanLogger.class, Category.BEAN.getName());
  ...
  @LogMessage(level = Level.TRACE)
  @Message(id = 4, value = "Exactly one post construct method ({0}) for {1}",
           format = Format.MESSAGE_FORMAT)
  void
  foundOnePostConstructMethod(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 6, value = "Exactly one pre destroy method ({0}) for {1}",
           format = Format.MESSAGE_FORMAT)
  void
  foundOnePreDestroyMethod(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 7, value = "Created session bean proxy for {0}",
           format = Format.MESSAGE_FORMAT)
  void
  createdSessionBeanProxy(Object param1);
  ...
  @Message(id = 8,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  callProxiedMethod(Object param1, Object param2, Object param3, Object param4);
  ...
  @LogMessage(level = Level.TRACE)
  @Message(id = 10, value = "Using qualifiers {0} for {1}",
           format = Format.MESSAGE_FORMAT)
  void
  qualifiersUsed(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 12, value = "Building bean metadata for {0}",
           format = Format.MESSAGE_FORMAT)
  void
  creatingBean(Object param1);

  @LogMessage(level = Level.TRACE)
  @Message(id = 14, value = "Using name {0} for {1}",
           format = Format.MESSAGE_FORMAT)
  void
  usingName(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 16, value = "Using scope {0} for {1}",
           format = Format.MESSAGE_FORMAT)
  void
  usingScope(Object param1, Object param2);
  ...
  @Message(id = 19, value = "Error destroying an instance {0} of {1}",
           format = Format.MESSAGE_FORMAT)
  void
  errorDestroying(Object param1, Object param2);

  @Message(id = 23, value = "Type parameter must be a concrete type:  {0}",
           format = Format.MESSAGE_FORMAT)
  String
  ...
  @Message(
      id = 26,
      value =
          "Security Services not available - unable to obtain the Principal")
  IllegalStateException
  ...
  @Message(id = 31,
           ...
           format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  interceptionTypeLifecycle(Object param1);

  @Message(id = 32, value = "InterceptionType must be lifecycle, but it is {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  interceptionTypeNotLifecycle(Object param1);

  @Message(id = 33, value = "Could not instantiate client proxy for {0}",
           format = Format.MESSAGE_FORMAT)
  String
  proxyInstantiationFailed(Object param1);

  @Message(
      id = 34,
      value =
          "Could not access bean correctly when creating client proxy for {0}",
      format = Format.MESSAGE_FORMAT)
  String
  proxyInstantiationBeanAccessFailed(Object param1);

  @Message(id = 35, value = "There was an error creating an id for {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  beanIdCreationFailed(Object param1);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  typedClassNotInHierarchy(Object param1, Object param2, Object types);
  ...
  multipleScopesFoundFromStereotypes(Object declaredOn, Object stereotypes,
                                     Object possibleScopes, String stack);
  ...
  @Message(id = 42,
           ...
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  nonContainerDecorator(Object param1);

  @Message(id = 43,
           value = "The following bean is not an EE resource producer:  {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  beanNotEeResourceProducer(Object param1);

  @Message(id = 44, value = "Unable to obtain instance from {0}",
           format = Format.MESSAGE_FORMAT)
  NullInstanceException
  nullInstance(Object param1);
  ...
  @Message(id = 46, value = "At most one scope may be specified on {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  onlyOneScopeAllowed(Object param1);

  @Message(id = 47, value = "Specializing bean must extend another bean:  {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  specializingBeanMustExtendABean(Object param1);

  @Message(id = 48, value = "Conflicting interceptor bindings found on {0}",
           format = Format.MESSAGE_FORMAT)
  String
  conflictingInterceptorBindings(Object param1);

  @Message(id = 49, value = "Unable to invoke {0} on {1}",
           format = Format.MESSAGE_FORMAT)
  WeldException
  ...
  unserializableProductInjectionError(Object producer,
                                      Object producerStackElement, Object ip,
                                      Object ipStackElement);

  @Message(id = 59, value = "No delegate injection point defined for {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  noDelegateInjectionPoint(Object param1);
  ...
  @Message(id = 61,
           ...
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  delegateMustSupportEveryDecoratedType(Object decoratedType, Object decorator);

  @Message(id = 64, value = "Unable to process decorated type: {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  unableToProcessDecoratedType(Object decoratedType);

  @Message(
      id = 66,
      value =
          "{0} has more than one @Dispose parameter \n\tat {1}\n  StackTrace:",
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  ...
  @Message(id = 80, value = "Enterprise beans cannot be interceptors:  {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  ejbCannotBeInterceptor(Object param1);

  @Message(id = 81, value = "Enterprise beans cannot be decorators:  {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  ...
  @Message(id = 85, value = "Cannot destroy null instance of {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  ...
  @Message(id = 94,
           ...
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  injectedFieldCannotBeProducer(Object param1, Object param2);
  ...
  @Message(id = 99,
           ...
           format = Format.MESSAGE_FORMAT)
  WeldException
  cannotLoadClass(Object param1, @Cause Throwable cause);
  ...
  @Message(id = 1502,
           ...
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  nonDependentResourceProducerField(Object param1);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  createdNewClientProxyType(Object param1, Object param2, Object param3);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1507, value = "Located client proxy of type {0} for bean {1}",
           format = Format.MESSAGE_FORMAT)
  void
  lookedUpClientProxy(Object param1, Object param2);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  injectionTargetCannotBeCreatedForInterface(Object param1);
  ...
  @Message(id = 1512, value = "{0} cannot be constructed for {1}",
           format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  ...
  @Message(id = 1515, value = "Unable to load annotated member {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  unableToLoadMember(Object param1);
  ...
  @Message(id = 1524,
           ...
           format = Format.MESSAGE_FORMAT)
  WeldException
  unableToLoadProxyClass(Object param1, Object param2, @Cause Throwable cause);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  DeploymentException
  passivatingBeanHasNonPassivationCapableDecorator(Object param1,
                                                   Object param2);
  ...
  @Message(id = 1530, value = "Cannot produce an instance of {0}.",
           format = Format.MESSAGE_FORMAT)
  CreationException
  injectionTargetCannotProduceInstance(Object param1);
  ...
  @Message(id = 1532,
           ...
           format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  passivationCapableBeanHasNullId(Object param1);
  ...
  /**
   * ID of this message was originally 0 but in jboss-logging zero is a special
   * value meaning no ID
   */
  @LogMessage(level = Level.TRACE)
  @Message(id = 1536,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  foundInjectableConstructors(Object param1, Object param2);
  ...
  @Message(id = 1538,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  createdContextInstance(Object param1, Object param2);
  ...
  @Message(id = 1539,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  createdMethodHandlerInitializerForDecoratorProxy(Object param1);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1540, value = "Adding method to enterprise proxy: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  addingMethodToEnterpriseProxy(Object param1);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1541, value = "Adding method to proxy: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  addingMethodToProxy(Object param1);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1542, value = "Retrieving/generating proxy class {0}",
           format = Format.MESSAGE_FORMAT)
  void
  generatingProxyClass(Object param1);
  ...
  @Message(id = 1543,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  createdProxyClass(Object param1, Object param2);
  ...
  @Message(id = 1544,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  methodHandlerProcessingReturningBeanInstance(Object param1);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1545, value = "MethodHandler processing call to {0} for {1}",
           format = Format.MESSAGE_FORMAT)
  void
  methodHandlerProcessingCall(Object param1, Object param2);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  settingNewMethodHandler(Object param1, Object param2);
  ...
  @Message(id = 1547,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  invokingInterceptorChain(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1548, value = "Invoking method {0} directly on {1}",
           format = Format.MESSAGE_FORMAT)
  void
  invokingMethodDirectly(Object param1, Object param2);
  ...
  @Message(id = 1552,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  extensionWithNonStaticPublicField(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 1553, value = "Proxy activated after passivation for {0}",
           format = Format.MESSAGE_FORMAT)
  void
  activatedSessionBeanProxy(Object param1);

  @Message(id = 1554, value = "Bean.{0}() returned null for {1}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  beanMethodReturnsNull(Object param1, Object param2);

  @Message(id = 1555, value = "Decorator.{0}() returned null for {1}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  decoratorMethodReturnsNull(Object param1, Object param2);

  @Message(id = 1556,
           value = "Specializing {0} cannot specialize a non-managed bean {1}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  specializingManagedBeanCanExtendOnlyManagedBeans(Object param1,
                                                   Object param2);

  @LogMessage(level = Level.WARN)
  @Message(id = 1557, value = "Unable to dump the proxy class file for {0}",
           format = Format.MESSAGE_FORMAT)
  void
  beanCannotBeDumped(Object param1, @Cause Throwable cause);
  ...
  @Message(id = 1558,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  directoryCannotBeCreated(Object param1);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  beanBuilderInvalidCreateCallback(Object param1);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  beanBuilderInvalidDestroyCallback(Object param1);

  @Message(id = 1561, value = "Bean builder {0} does not define a BeanManager.",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  IllegalStateException
  statelessSessionBeanInjectionPointMetadataNotAvailable();

  @Message(
      id = 1565,
      value =
          "Interceptor builder {0} does not define an interception function.",
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  noInterceptionFunction(Object param1);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  DefinitionException
  noInterceptionType(Object param1);

  @Message(id = 1567, value = "Cannot create contextual instance of {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  cannotCreateContextualInstanceOfBuilderInterceptor(Object param1);

  @Message(id = 1568, value = "Unable to create ClassFile for: {1}.",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  IllegalStateException
  noCallbackSpecifiedForCustomBean(Object bean);

  @LogMessage(level = Level.INFO)
  @Message(id = 1571, value = "Proxy for {0} created in {1} because {2}.",
           format = Format.MESSAGE_FORMAT)
  void
  ...
  creatingProxyInstanceUsingDifferentInstantiator(Object proxyClass,
                                                  Object newInstantiator,
                                                  Object oldInstantiator);
  ...
  @Message(id = 1580,
           ...
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  tryingToResolveContextualReferenceAfterDestroyWasInvoked(Object handler);
}

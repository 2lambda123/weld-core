...
public interface BootstrapLogger extends WeldLogger {
  ...
  BootstrapLogger LOG = Logger.getMessageLogger(BootstrapLogger.class,
                                                Category.BOOTSTRAP.getName());

  BootstrapLogger TRACKER_LOG = Logger.getMessageLogger(
      BootstrapLogger.class, Category.BOOTSTRAP_TRACKER.getName());
  ...
  @LogMessage(level = Level.DEBUG)
  @Message(id = 103, value = "Enabled alternatives for {0}: {1}",
           format = Format.MESSAGE_FORMAT)
  void
  enabledAlternatives(Object param1, Object param2);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 104, value = "Enabled decorator types for {0}: {1}",
           format = Format.MESSAGE_FORMAT)
  void
  enabledDecorators(Object param1, Object param2);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 105, value = "Enabled interceptor types for {0}: {1}",
           format = Format.MESSAGE_FORMAT)
  void
  enabledInterceptors(Object param1, Object param2);
  ...
  @LogMessage(level = Level.DEBUG)
  @Message(id = 109, value = "ObserverMethod: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  ...
  beanTypeNotEjb(Object param1);

  @Message(id = 112,
           value = "Class {0} has both @Interceptor and @Decorator annotations",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  beanIsBothInterceptorAndDecorator(Object param1);

  @Message(id = 113, value = "BeanDeploymentArchive must not be null:  {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  deploymentArchiveNull(Object param1);
  ...
  @Message(id = 117,
           ...
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  unspecifiedRequiredService(Object service, Object target);

  @Message(id = 118, value = "Only normal scopes can be passivating. Scope {0}",
           format = Format.MESSAGE_FORMAT)
  DefinitionException
  passivatingNonNormalScopeIllegal(Object param1);
  ...
  @Message(id = 123, value = "Error loading {0} defined in {1}",
           format = Format.MESSAGE_FORMAT)
  DeploymentException
  errorLoadingBeansXmlEntry(Object param1, Object param2,
                            @Cause Throwable cause);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 124, value = "Using {0} threads for bootstrap",
           format = Format.MESSAGE_FORMAT)
  void
  threadsInUse(Object param1);

  @Message(id = 125, value = "Invalid thread pool size: {0}",
           format = Format.MESSAGE_FORMAT)
  DeploymentException
  invalidThreadPoolSize(Object param1);

  @LogMessage(level = Level.WARN)
  @Message(id = 126, value = "Timeout shutting down thread pool {0} at {1}",
           format = Format.MESSAGE_FORMAT)
  void
  timeoutShuttingDownThreadPool(Object param1, Object param2);

  @Message(id = 127, value = "Invalid thread pool type: {0}",
           format = Format.MESSAGE_FORMAT)
  DeploymentException
  invalidThreadPoolType(Object param1);

  @Message(id = 128, value = "Invalid value for property {0}: {1}",
           format = Format.MESSAGE_FORMAT)
  DeploymentException
  invalidPropertyValue(Object param1, Object param2);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  IllegalArgumentException
  annotatedTypeJavaClassMismatch(Object param1, Object param2);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 132, value = "Disabled alternative (ignored): {0}",
           format = Format.MESSAGE_FORMAT)
  void
  foundDisabledAlternative(Object param1);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 133, value = "Specialized bean (ignored): {0}",
           format = Format.MESSAGE_FORMAT)
  void
  foundSpecializedBean(Object param1);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  foundProducerOfSpecializedBean(Object param1);
  ...
  @Message(id = 137, value = "Exception while loading class '{0}' : {1}",
           format = Format.MESSAGE_FORMAT)
  void
  exceptionWhileLoadingClass(Object param1, Object param2);

  @LogMessage(level = Level.TRACE)
  @Message(id = 138, value = "Error while loading class '{0}' : {1}",
           format = Format.MESSAGE_FORMAT)
  void
  errorWhileLoadingClass(Object param1, Object param2);
  ...
  @Message(id = Message.NONE,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  patSkipped(SlimAnnotatedType<?> type);
  ...
  @Message(id = Message.NONE,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  patDefaultResolver(SlimAnnotatedType<?> type);
  ...
  @Message(id = 145, value = "Bean identifier index built:\n  {0}",
           format = Format.MESSAGE_FORMAT)
  void
  beanIdentifierIndexBuilt(Object info);
  ...
  @Message(
      id = 152,
      value =
          "ProcessProducer.setProducer() called by {0}: {1} replaced by {2}",
      format = Format.MESSAGE_FORMAT)
  void
  setProducerCalled(Object extensionName, Object original, Object newer);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  addAnnotatedTypeCalled(Object extensionName, Object type);
  ...
  @Message(id = 154,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  addBeanCalled(Object extensionName, Object type);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  addObserverMethodCalled(Object extensionName, Object type);
  ...
  @Message(id = 156,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  addContext(Object extensionName, Object type);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  addDefinitionErrorCalled(Object extensionName, Object type);
  ...
  @Message(id = 158,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  addQualifierCalled(Object extensionName, Object type);
  ...
  @Message(id = 159,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  addScopeCalled(Object extensionName, Object type);
  ...
  @Message(id = 160,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  addStereoTypeCalled(Object extensionName, Object type);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  addAnnotatedTypeCalledInBBD(Object extensionName, Object type);

  @Message(id = 163,
           value = "Non-unique bean deployment identifier detected: {0}",
           format = Format.MESSAGE_FORMAT)
  DeploymentException
  nonuniqueBeanDeploymentIdentifier(Object info);
  ...
  @Message(id = 164,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  annotatedTypeVetoed(Object extensionName, Object type);
  ...
  @Message(id = 165,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  beanAttributesVetoed(Object extensionName, Object type);

  @LogMessage(level = Logger.Level.DEBUG)
  @Message(id = 166, value = "AfterTypeDiscovery.{3} modified by {0} {2} {1}",
           format = Format.MESSAGE_FORMAT)
  void
  typeModifiedInAfterTypeDiscovery(Object extensionName, Object type,
                                   Object operation, Object types);
  ...
  annotatedTypeNotRegisteredAsBeanDueToMissingAppropriateConstructor(
      String clazzName, String annotationName);

  @LogMessage(level = Logger.Level.DEBUG)
  @Message(id = 168, value = "Extension bean deployed: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  extensionBeanDeployed(Object extension);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  configureQualifierCalled(Object extensionName, Object type);
  ...
  @Message(id = 173,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  configureProducerCalled(Object extensionName, Object bean);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  ignoreFinalMethodsCalled(Object extensionName, Object bean);
  ...
  @Message(
      ...
      format = Format.MESSAGE_FORMAT)
  void
  configureAnnotatedTypeCalled(Object extensionName, Object bean);
  ...
  @Message(id = 179, value = "{0} created by {1} cannot be processed",
           format = Format.MESSAGE_FORMAT)
  DeploymentException
  unableToProcessConfigurator(Object configurator, Object extensionName,
                              @Cause Throwable cause);

  @LogMessage(level = Logger.Level.DEBUG)
  @Message(id = 180, value = "Drop unused bean metadata: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  dropUnusedBeanMetadata(Object bean);

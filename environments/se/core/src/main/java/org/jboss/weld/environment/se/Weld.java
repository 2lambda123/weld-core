...
@Vetoed
public class Weld
    extends SeContainerInitializer implements ContainerInstanceFactory {

  /**
   * By default, the set of bean-defining annotations is fixed. If set to a
   * {@link Set} of annotation classes, the set of bean-defining annotations is
  ...
  /**
   * By default, bean archive isolation is enabled. If set to false, Weld will
   * use a "flat" deployment structure - all bean classes share the same bean
  ...
  public static final String ARCHIVE_ISOLATION_SYSTEM_PROPERTY =
      "org.jboss.weld.se.archive.isolation";

  /**
   * By default, the development mode is disabled. If set to true, the
   * development mode is activated <p> This key can be also used through {@link
   * #property(String, Object)}.
   */
  public static final String DEV_MODE_SYSTEM_PROPERTY =
      "org.jboss.weld.development";

  /**
   * By default, Weld automatically registers shutdown hook during
   * initialization. If set to false, the registration of a shutdown hook is
   * skipped. <p> This key can be also used through {@link #property(String,
   * Object)}.
   */
  ...
  /**
   * By default, Weld SE does not support implicit bean archives without
   * beans.xml. If set to true, Weld scans the class path entries and implicit
   * bean archives which don't contain a beans.xml file are also supported. <p>
   * This key can be also used through {@link #property(String, Object)}.
   */
  public static final String SCAN_CLASSPATH_ENTRIES_SYSTEM_PROPERTY =
      "org.jboss.weld.se.scan.classpath.entries";

  /**
   * See also the CDI specification, section <b>15.1 Bean archive in Java
   * SE</b>.
   */
  ...
  /**
   * By default, Weld is allowed to perform efficient cleanup and further
   * optimizations after bootstrap. This feature is normally controlled by
   * integrator through {@link ConfigurationKey#ALLOW_OPTIMIZED_CLEANUP} but in
   * Weld SE a client of the bootstrap API is de facto in the role of
   * integrator. <p> This key can be also used through {@link #property(String,
   * Object)}.
   */
  ...
  static {
    if (!(SingletonProvider.instance() instanceof RegistrySingletonProvider)) {
      // make sure RegistrySingletonProvider is used (required for supporting
      // multiple parallel Weld instances)
  ...
  protected final Set<Class<? extends Annotation>>
  ...
  /**
   * Containers must have a unique identifier assigned when running multiple
   * Weld instances at the same time.
   *
   * @param containerId
   * @return self
   */
  ...
  /**
   * All classes from the packages of the specified classes will be added to the
   * set of bean classes for the synthetic bean archive.
   *
   * <p>
   * Note that the scanning possibilities are limited. Therefore, only
   * directories and jar files from the filesystem are supported.
   * </p>
   *
   * <p>
  ...
  /**
   * Packages of the specified classes will be scanned and found classes will be
   * added to the set of bean classes for the synthetic bean archive.
   *
  ...
  /**
   * A package of the specified class will be scanned and found classes will be
   * added to the set of bean classes for the synthetic bean archive.
   *
   * @param scanRecursively
   * @param packageClass
  ...
  public Weld addExtension(Extension extension) {
    extensions.add(new MetadataImpl<Extension>(
        extension, SYNTHETIC_LOCATION_PREFIX + extension.getClass().getName()));
    return this;
  }
  ...
  public Weld addExtensions(Class<? extends Extension>... extensionClasses) {
    for (Class<? extends Extension> extensionClass : extensionClasses) {
      try {
        ...
        CommonLogger.LOG.unableToInstantiate(extensionClass, new Object[] {},
                                             ex);
      }
    }
    return this;
  ...
  /**
   * Enable interceptors for the synthetic bean archive, all previous values are
   * removed. <p> This method does not add any class to the set of bean classes
   * for the synthetic bean archive. It's purpose is solely to compensate the
  ...
  /**
   * Add an interceptor class to the list of enabled interceptors for the
   * synthetic bean archive. <p> This method does not add any class to the set
   * of bean classes for the synthetic bean archive. It's purpose is solely to
   * compensate the absence of the <code>beans.xml</code> descriptor.
   *
  ...
  /**
   * Enable decorators for the synthetic bean archive, all previous values are
   * removed. <p> This method does not add any class to the set of bean classes
   * for the synthetic bean archive. It's purpose is solely to compensate the
   * absence of the <code>beans.xml</code> descriptor.
   *
  ...
  /**
   * Add a decorator class to the list of enabled decorators for the synthetic
   * bean archive. <p> This method does not add any class to the set of bean
   * classes for the synthetic bean archive. It's purpose is solely to
   * compensate the absence of the <code>beans.xml</code> descriptor.
   *
  ...
  /**
   * Select alternatives for the synthetic bean archive, all previous values are
   * removed. <p> This method does not add any class to the set of bean classes
   * for the synthetic bean archive. It's purpose is solely to compensate the
   * absence of the <code>beans.xml</code> descriptor.
   *
  ...
  /**
   * Add an alternative class to the list of selected alternatives for a
   * synthetic bean archive. <p> This method does not add any class to the set
   * of bean classes for the synthetic bean archive. It's purpose is solely to
   * compensate the absence of the <code>beans.xml</code> descriptor.
   *
  ...
  /**
   * Select alternative stereotypes for the synthetic bean archive, all previous
   * values are removed. <p> This method does not add any class to the set of
   * bean classes for the synthetic bean archive. It's purpose is solely to
   * compensate the absence of the <code>beans.xml</code> descriptor.
   *
   ...
   */
  @SafeVarargs
  public final Weld alternativeStereotypes(
  ...
  @SuppressWarnings("unchecked")
  @Override
  public Weld selectAlternativeStereotypes(
      Class<? extends Annotation>... alternativeStereotypeClasses) {
    for (Class<? extends Annotation> alternativeStereotypeClass :
  ...
  /**
   * Add an alternative stereotype class to the list of selected alternative
   * stereotypes for a synthetic bean archive. <p> This method does not add any
   * class to the set of bean classes for the synthetic bean archive. It's
   * purpose is solely to compensate the absence of the <code>beans.xml</code>
   * descriptor.
   *
   * @param alternativeStereotypeClass
   * @return self
   */
  public Weld addAlternativeStereotype(
      Class<? extends Annotation> alternativeStereotypeClass) {
    selectedAlternativeStereotypes.add(
        syntheticMetadata(alternativeStereotypeClass));
    return this;
  }
  ...
  /**
   * Register per-deployment services which are shared across the entire
   * application. <p> Weld uses services to communicate with its environment,
   * e.g. {@link org.jboss.weld.manager.api.ExecutorServices} or
   * {@link org.jboss.weld.transaction.spi.TransactionServices}.
   * </p>
   * <p>
   * Service implementation may specify their priority using {@link Priority}.
   * Services with higher priority have precedence. Services that do not specify
  ...
  public Weld addServices(Service... services) {
    for (Service service : services) {
      for (Class<? extends Service> serviceInterface :
           Services.identifyServiceInterfaces(service.getClass(),
                                              new HashSet<>())) {
  ...
  /**
   * Sets the bean discovery mode for synthetic bean archive. Default mode is
   * ALL.
   * @param mode bean discovery mode in a form of an enum from {@link
   *     org.jboss.weld.bootstrap.spi.BeanDiscoveryMode}. Accepted values are
   *     ALL, ANNOTATED
   *
   * @return  self
   * @throws IllegalArgumentException if BeanDiscoveryMode.NONE is passed as an
   *     argument
   */
  ...
  /**
   * Reset the synthetic bean archive (bean classes and enablement), explicitly
   * added extensions and services.
   *
   * @return self
   */
  public Weld reset() {
  ...
  /**
   * By default, the discovery is enabled. However, it's possible to disable the
   * discovery completely so that only the "synthetic" bean archive is
   * considered.
   *
   * @return self
   */
  ...
  /**
   *
   * @return <code>true</code> if the discovery is enabled, <code>false</code>
   *     otherwise
   * @see #disableDiscovery()
   */
  ...
  /**
   * Bootstraps a new Weld SE container with the current container id (generated
   * value if not set through {@link #containerId(String)}). <p/> The container
   * must be shut down properly when an application is stopped. Applications are
   * encouraged to use the try-with-resources statement or invoke
   * {@link WeldContainer#shutdown()} explicitly.
   * <p/>
   * However, a shutdown hook is also registered during initialization so that
   * all running containers are shut down automatically when a program exits or
   * VM is terminated. This means that it's not necessary to implement the
   * shutdown logic in a class where a main method is used to start the
   * container.
   *
  ...
  public WeldContainer initialize() {
    ...
    // If also building a synthetic bean archive or the implicit scan is
    // enabled, the check for beans.xml is not necessary
    ...
    final ExternalConfigurationBuilder configurationBuilder =
        new ExternalConfigurationBuilder()
            ...
            .add(ConfigurationKey.ALLOW_OPTIMIZED_CLEANUP.get(),
                 isEnabled(ALLOW_OPTIMIZED_CLEANUP, true));
    for (Entry<String, Object> property : properties.entrySet()) {
      String key = property.getKey();
      if (SHUTDOWN_HOOK_SYSTEM_PROPERTY.equals(key) ||
          ARCHIVE_ISOLATION_SYSTEM_PROPERTY.equals(key) ||
          DEV_MODE_SYSTEM_PROPERTY.equals(key) ||
    ...
    final String containerId = this.containerId != null
                                   ? this.containerId
                                   : UUID.randomUUID().toString();
    bootstrap.startContainer(containerId, Environments.SE, deployment);

    final WeldContainer weldContainer =
        WeldContainer.startInitialization(containerId, deployment, bootstrap);
    ...
    try {
      ...
      WeldContainer.endInitialization(
          weldContainer, isEnabled(SHUTDOWN_HOOK_SYSTEM_PROPERTY, true));
      initializedContainers.put(containerId, weldContainer);
    } catch (Throwable e) {
      // Discard the container if a bootstrap problem occurs, e.g. validation
      // error
  ...
  /**
   * Set a {@link ClassLoader}. The given {@link ClassLoader} will be scanned
   * automatically for bean archives if scanning is enabled.
   *
   * @param classLoader
   * @return self
   */
  ...
  /**
   * Set a {@link ResourceLoader} used to scan the application for bean
   * archives. If you only want to use a specific {@link ClassLoader} for
   * scanning, use
  ...
  /**
   * Scans the class path entries - implicit bean archives which don't contain a
   * beans.xml file are supported.
   *
   * @return self
  ...
  /**
   * Registers annotations which will be considered as bean defining
   * annotations.
   *
   * NOTE - If used along with {@code <trim/>} bean archives and/or with Weld
   * configuration key
   * {@code org.jboss.weld.bootstrap.vetoTypesWithoutBeanDefiningAnnotation},
   * these annotations will be ignored.
   *
   * @param annotations annotations which will be considered as Bean Defining
   *     Annotations.
   * @return self
   */
  public Weld
  ...
  /**
   * <p>
   * Extensions to Weld SE can subclass and override this method to customize
  ...
  protected Deployment createDeployment(ResourceLoader resourceLoader,
    ...
    final Set<WeldBeanDeploymentArchive> beanDeploymentArchives =
        new HashSet<WeldBeanDeploymentArchive>();
    final Map<Class<? extends Service>, Service> additionalServices =
        new HashMap<>(this.additionalServices);
    final Set<Class<? extends Annotation>> beanDefiningAnnotations =
        ImmutableSet.<Class<? extends Annotation>>builder()
            ...
            // Add ThreadScoped manually as Weld SE doesn't support implicit
            // bean archives without beans.xml
            .add(ThreadScoped.class)
            // Add all custom bean defining annotations user registered via
    ...
    if (discoveryEnabled) {
      DiscoveryStrategy strategy = DiscoveryStrategyFactory.create(
          resourceLoader, bootstrap, beanDefiningAnnotations,
          isEnabled(Jandex.DISABLE_JANDEX_DISCOVERY_STRATEGY, false));
    ...
    if (isSyntheticBeanArchiveRequired()) {
      ...
      if (BeanDiscoveryMode.ANNOTATED.equals(beanDiscoveryMode)) {
        ...
        ImmutableSet.Builder<String> filteredSetbuilder =
            ImmutableSet.builder();
        for (String className : setOfAllBeanClasses) {
          Class<?> clazz = Reflections.loadClass(resourceLoader, className);
          if (clazz != null && Reflections.hasBeanDefiningAnnotation(
                                   clazz, beanDefiningAnnotations)) {
      ...
      WeldBeanDeploymentArchive syntheticBeanArchive =
          new WeldBeanDeploymentArchive(
              WeldDeployment.SYNTHETIC_BDA_ID, setOfAllBeanClasses, null,
              buildSyntheticBeansXml(), Collections.emptySet(),
              ImmutableSet.copyOf(beanClasses));
      beanDeploymentArchives.add(syntheticBeanArchive);
    }

    if (beanDeploymentArchives.isEmpty() &&
        this.containerLifecycleObservers.isEmpty() &&
        this.extensions.isEmpty()) {
      throw WeldSELogger.LOG
          .weldContainerCannotBeInitializedNoBeanArchivesFound();
    }

    Multimap<String, BeanDeploymentArchive> problems =
        BeanArchives.findBeanClassesDeployedInMultipleBeanArchives(
            beanDeploymentArchives);
    if (!problems.isEmpty()) {
      // Right now, we only log a warning for each bean class deployed in
      // multiple bean archives
      for (Entry<String, Collection<BeanDeploymentArchive>> entry :
           problems.entrySet()) {
    ...
    if (isEnabled(ARCHIVE_ISOLATION_SYSTEM_PROPERTY, true)) {
      deployment = new WeldDeployment(resourceLoader, bootstrap,
                                      beanDeploymentArchives, extensions);
      CommonLogger.LOG.archiveIsolationEnabled();
    } else {
      Set<WeldBeanDeploymentArchive> flatDeployment =
          new HashSet<WeldBeanDeploymentArchive>();
      flatDeployment.add(
          WeldBeanDeploymentArchive.merge(bootstrap, beanDeploymentArchives));
      deployment = new WeldDeployment(resourceLoader, bootstrap, flatDeployment,
                                      extensions);
      CommonLogger.LOG.archiveIsolationDisabled();
    }

    // Register additional services if a service with higher priority not
    // present
    for (Entry<Class<? extends Service>, Service> entry :
         additionalServices.entrySet()) {
   ...
   * @throws UnsatisfiedResolutionException if no beans can be resolved *
   ...
   *     the given bean
   */
  protected <T> T getInstanceByType(BeanManager manager, Class<T> type,
                                    Annotation... bindings) {
  ...
  protected Iterable<Metadata<Extension>> getExtensions() {
    ...
    for (Metadata<Extension> metadata : result) {
      if (metadata.getValue().getClass().getName().equals(
    ...
    if (weldSEBeanRegistrant == null) {
      try {
        weldSEBeanRegistrant =
            SecurityActions.newInstance(WeldSEBeanRegistrant.class);
    ...
    if (isEnabled(DEV_MODE_SYSTEM_PROPERTY, false)) {
      ...
      result.add(new MetadataImpl<Extension>(
          DevelopmentMode.getProbeExtension(resourceLoader), "N/A"));
    }
    if (!containerLifecycleObservers.isEmpty()) {
      result.add(new MetadataImpl<Extension>(
          new ContainerLifecycleObserverExtension(containerLifecycleObservers),
          SYNTHETIC_LOCATION_PREFIX +
              ContainerLifecycleObserver.class.getName()));
    }
    return result;
  }

  private Iterable<Metadata<Extension>>
  loadExtensions(ResourceLoader resourceLoader) {
  ...
  protected BeansXml buildSyntheticBeansXml() {
    return new BeansXmlImpl(
        ...
        ImmutableList.copyOf(enabledInterceptors), Scanning.EMPTY_SCANNING,
        null, beanDiscoveryMode, null, false);
  }

  private MetadataImpl<String> syntheticMetadata(Class<?> clazz) {
    return new MetadataImpl<String>(clazz.getName(), SYNTHETIC_LOCATION_PREFIX +
                                                         clazz.getName());
  }
      ...
      if (resourceUrl != null) {
        ...
        try {
          ...
          if (PROCOTOL_FILE.equals(resourceUrl.getProtocol())) {
            ...
            handleDir(file.isDirectory() ? file : file.getParentFile(),
                      packInfo.isScanRecursively(), packName, foundClasses);
          } else if (PROCOTOL_JAR.equals(resourceUrl.getProtocol())) {
            handleJar(resourceUri, packInfo.isScanRecursively(), packName,
                      foundClasses);
          } else {
  ...
  private void handleDir(File packDir, boolean scanRecursively, String packName,
      ...
      for (File file : packDir.listFiles()) {
        if (file.isFile()) {
          if (file.canRead() && Files.isClass(file.getName())) {
            foundClasses.add(
                Files.filenameToClassname(packName + "." + file.getName()));
          }
        }
        if (file.isDirectory() && scanRecursively) {
          handleDir(file, scanRecursively, packName + "." + file.getName(),
                    foundClasses);
        }
      }
    }
  ...
  private void handleJar(URI resourceUri, boolean scanRecursively,
                         String packName, Set<String> foundClasses) {

    // Currently we only support jar:file
    if (resourceUri.getSchemeSpecificPart().startsWith(PROCOTOL_FILE)) {

      // Get the JAR file path, e.g. "jar:file:/home/duke/duke.jar!/com/foo/Bar"
      // becomes "/home/duke/duke.jar"
      String path = resourceUri.getSchemeSpecificPart().substring(
          PROTOCOL_FILE_PART.length());
  ...
  private String[] splitBySlash(String value) { return value.split("/"); }
  ...
  protected boolean isEnabled(String key, boolean defaultValue) {
    ...
    String system =
        AccessController.doPrivileged(new GetSystemPropertyAction(key));
    if (system != null) {
  ...
  /**
   * Parses additional bean defining annotations from either system properties,
   * or SE container properties.
   */
  private void parseAdditionalBeanDefiningAnnotations() {
    ...
    if (properties.containsKey(ADDITIONAL_BEAN_DEFINING_ANNOTATIONS_PROPERTY)) {
      Object valueObj =
          properties.get(ADDITIONAL_BEAN_DEFINING_ANNOTATIONS_PROPERTY);
      if (valueObj instanceof Collection) {
        for (Object element : ((Collection<?>)valueObj)) {
          if (element instanceof Class<?> &&
              Annotation.class.isAssignableFrom((Class<?>)element)) {
            extendedBeanDefiningAnnotations.add(
                (Class<? extends Annotation>)element);
          } else {
            // one of the values is not an annotation, log warning
            WeldSELogger.LOG.unexpectedItemsInValueCollection(
                element.getClass());
          }
        }
      } else {
    ...
    String stringValue =
        AccessController.doPrivileged(new GetSystemPropertyAction(
  ...
  private static class PackInfo {
    ...
    public URL getResourceUrl(ResourceLoader resourceLoader) {
      if (classLoaderRef != null) {
        return classLoaderRef.get().getResource(
            this.getPackClassName().replace('.', '/') +
            Files.CLASS_FILE_EXTENSION);
      } else {
    ...
    public String getPackClassName() { return packClassName; }

    public boolean isScanRecursively() { return scanRecursively; }
    ...
    public int hashCode() {
      ...
      int result = 1;
      result = prime * result +
               ((packClassName == null) ? 0 : packClassName.hashCode());
      return result;
    }

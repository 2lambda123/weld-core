...
/**
 * A source of localized log/bundle messages and exceptions. Note that this
 * interface extends {@link WeldEnvironmentLogger} so that regular logger
...
public interface WeldSELogger extends WeldEnvironmentLogger {
  ...
  WeldSELogger LOG =
      Logger.getMessageLogger(WeldSELogger.class, Category.BOOTSTRAP.getName());

  @Message(id = 2000, value = "Weld SE container {0} is already running!",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  weldContainerAlreadyRunning(Object id);

  @LogMessage(level = Level.INFO)
  @Message(id = 2001, value = "Weld SE container {0} shut down",
           format = Format.MESSAGE_FORMAT)
  void
  weldContainerShutdown(Object id);
  ...
  @LogMessage(level = Level.INFO)
  @Message(id = 2003, value = "Weld SE container {0} initialized",
           format = Format.MESSAGE_FORMAT)
  void
  weldContainerInitialized(Object id);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 2004, value = "Scanning package {0}, class resource: {1}",
           format = Format.MESSAGE_FORMAT)
  void
  scanningPackage(Object packageName, Object resource);
  ...
  @Message(id = 2005,
           ...
           format = Format.MESSAGE_FORMAT)
  void
  packageNotFound(Object packageName);
  ...
  @LogMessage(level = Level.DEBUG)
  @Message(id = 2007, value = "Resource URL procotol not supported: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  resourceUrlProtocolNotSupported(Object resource);
  ...
  @Message(
      id = 2009,
      value =
          "Weld SE container cannot be initialized - no bean archives found")
  IllegalStateException
  ...
  @Message(
      id = 2012,
      value =
          "The container lifecycle observer is not properly initialized: {0}",
      format = Format.MESSAGE_FORMAT)
  IllegalStateException
  containerLifecycleObserverNotInitialized(Object info);

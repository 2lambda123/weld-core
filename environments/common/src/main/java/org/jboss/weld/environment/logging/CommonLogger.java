...
public interface CommonLogger extends WeldEnvironmentLogger {
  ...
  @Message(id = 2, value = "Could not read resource with name: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  couldNotReadResource(Object param1, @Cause Throwable cause);
  ...
  @LogMessage(level = Level.WARN)
  @Message(id = 5, value = "JNLPClassLoader#getJarFile(URL) threw exception",
           format = Format.MESSAGE_FORMAT)
  void
  jnlpClassLoaderInternalException(@Cause Throwable cause);
  ...
  @Message(id = 7, value = "Error handling file path\n  File: {0}\n  Path: {1}",
           format = Format.MESSAGE_FORMAT)
  void
  cannotHandleFilePath(Object file, Object path, @Cause Throwable cause);
  ...
  @Message(id = 12, value = "Unable to load class {0}",
           format = Format.MESSAGE_FORMAT)
  ClassFileInfoException
  unableToLoadClass(Object param1);

  @Message(
      id = 13,
      value = "beans.xml defines unrecognized bean-discovery-mode value: {0}",
      format = Format.MESSAGE_FORMAT)
  IllegalStateException
  undefinedBeanDiscoveryValue(Object param1);
  ...
  @Message(id = 15, value = "Unable to load annotation: {0}",
           format = Format.MESSAGE_FORMAT)
  ClassFileInfoException
  unableToLoadAnnotation(Object param1);

  @Message(id = 16, value = "Missing beans.xml file in META-INF",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  missingBeansXml();

  @Message(id = 18,
           value = "Unable to resolve a bean for {0} with bindings {1}",
           format = Format.MESSAGE_FORMAT)
  UnsatisfiedResolutionException
  unableToResolveBean(Object param1, Object param2);

  @Message(id = 19,
           value = "Jandex index is null in the constructor of class: {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  jandexIndexNotCreated(Object param1);

  @LogMessage(level = Level.INFO)
  @Message(id = 20, value = "Using jandex for bean discovery",
           format = Format.MESSAGE_FORMAT)
  void
  usingJandex();
  ...
  @Message(
      id = 23,
      value =
          "Archive isolation disabled - only one bean archive will be created",
      format = Format.MESSAGE_FORMAT)
  void
  ...
  @Message(id = 25, value = "Index for name: {0} not found.",
           format = Format.MESSAGE_FORMAT)
  ClassFileInfoException
  indexForNameNotFound(Object param1);
  ...
  @LogMessage(level = Level.WARN)
  @Message(id = 28,
           value = "Weld initialization skipped - no bean archive found")
  void
  initSkippedNoBeanArchiveFound();

  @Message(id = 29, value = "Cannot load class for {0}.",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  cannotLoadClass(Object param1, @Cause Throwable cause);

  @LogMessage(level = Level.DEBUG)
  @Message(id = 30, value = "Cannot load class using the ResourceLoader: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  cannotLoadClassUsingResourceLoader(String className);
  ...
  @LogMessage(level = Level.DEBUG)
  @Message(id = 32, value = "Processing bean archive reference: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  ...
  @Message(id = 35, value = "Class path entry cannot be read: {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  cannotReadClassPathEntry(Object entry);

  @Message(id = 36,
           value = "Weld cannot read the java class path system property!",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  cannotReadJavaClassPathSystemProperty();

  @Message(id = 37, value = "Unable to initialize the Probe component: {0}",
           format = Format.MESSAGE_FORMAT)
  IllegalStateException
  ...
  @LogMessage(level = Level.DEBUG)
  @Message(id = 39, value = "Bean archive reference {0} handled by {1}",
           format = Format.MESSAGE_FORMAT)
  void
  beanArchiveReferenceHandled(Object beanArchiveRef, Object handler);

  @LogMessage(level = Level.INFO)
  @Message(id = 40, value = "Jandex discovery strategy was disabled.",
           format = Format.MESSAGE_FORMAT)
  void
  jandexDiscoveryStrategyDisabled();

  @LogMessage(level = Level.INFO)
  @Message(id = 41, value = "Using {0} for bean discovery",
           format = Format.MESSAGE_FORMAT)
  void
  usingServiceLoaderSourcedDiscoveryStrategy(Object discoveryStrategy);

  @LogMessage(level = Level.WARN)
  @Message(id = 42, value = "Class path entry does not exist: {0}",
           format = Format.MESSAGE_FORMAT)
  void
  classPathEntryDoesNotExist(Object entry);
}

...
public class SimpleAsyncListenerTest {
  ...
  public static WebArchive createTestArchive() {
    return baseDeployment().addClasses(
        SimpleAsyncListenerTest.class, FailingServlet.class,
        StatusServlet.class, AsyncServlet.class, AsyncRequestProcessor.class,
        SimpleAsyncListener.class);
  }
  ...
  public void testOnErrorCalledSuccesfully() throws Exception {
    ...
    assertTrue(results.getWebResponse().getContentAsString(),
               results.getWebResponse().getContentAsString().contains(
                   "onError: true"));
  }

...
public class NamedProducerTest {
  ...
  public static WebArchive createDeployment() {
    return ShrinkWrap
        .create(WebArchive.class,
                Utils.getDeploymentNameAsHash(NamedProducerTest.class,
                                              Utils.ARCHIVE_TYPE.WAR))
        .addClasses(User.class, NewUserAction.class, Employee.class,
                    SaveAction.class)
        .addAsWebInfResource(NamedProducerTest.class.getPackage(), "web.xml",
                             "web.xml")
        .addAsWebInfResource(NamedProducerTest.class.getPackage(),
                             "faces-config.xml", "faces-config.xml")
        .addAsWebResource(NamedProducerTest.class.getPackage(), "view.xhtml",
                          "view.xhtml")
        .addAsWebResource(NamedProducerTest.class.getPackage(), "home.xhtml",
                          "home.xhtml")
  ...
  public void testNamedProducerWorks() throws Exception {
    ...
    Assert.assertNotNull(
        getFirstMatchingElement(page, HtmlSubmitInput.class, "saveButton"));
  }
  ...
  public void testNamedProducerFieldLoosesValues() throws Exception {
    ...
    // Check the page rendered ok
    HtmlSubmitInput saveButton =
        getFirstMatchingElement(page, HtmlSubmitInput.class, "saveButton");
    HtmlTextInput employeeFieldName =
        getFirstMatchingElement(page, HtmlTextInput.class, "employeeFieldName");
    HtmlTextInput employeeMethodName = getFirstMatchingElement(
        page, HtmlTextInput.class, "employeeMethodName");

...
public class Weld1262Test {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
        .create(WebArchive.class,
                Utils.getDeploymentNameAsHash(Weld1262Test.class,
                                              Utils.ARCHIVE_TYPE.WAR))
        .addClasses(Crossroad.class, Guide.class)
        .addAsWebResource(Weld1262Test.class.getPackage(), "crossroad.xhtml",
                          "crossroad.xhtml")
        .addAsWebResource(Weld1262Test.class.getPackage(), "road.xhtml",
                          "road.xhtml")
        .addAsWebInfResource(Weld1262Test.class.getPackage(), "web.xml",
                             "web.xml")
        .addAsWebInfResource(Weld1262Test.class.getPackage(),
  ...
  public void testConversationPropagatedByNavigationHandler() throws Exception {
    ...
    HtmlPage road =
        getFirstMatchingElement(main, HtmlSubmitInput.class, "guide").click();
    assertEquals("Guide is active",
                 getFirstMatchingElement(road, HtmlSpan.class, "guideMessage")
                     .getTextContent());
  }
  ...
  public void testConversationNotPropagatedByFacesRedirect() throws Exception {
    ...
    HtmlPage main = startConversation();
    HtmlPage road =
        getFirstMatchingElement(main, HtmlSubmitInput.class, "redirect")
            .click();
    assertEquals("Guide is not active",
                 getFirstMatchingElement(road, HtmlSpan.class, "guideMessage")
                     .getTextContent());
  }
  ...
  public HtmlPage startConversation() throws Exception {
    ...
    main =
        getFirstMatchingElement(main, HtmlSubmitInput.class, "begin").click();
    String cid =
        getFirstMatchingElement(main, HtmlSpan.class, "cid").getTextContent();

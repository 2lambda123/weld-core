...
/**
 * TEMPORARY WORKAROUND - temporary replacement for NOOP {@link
 * org.jboss.as.arquillian.container.ExceptionTransformer} used by WildFly
 * managed container.
 *
 ...
 * @author Martin Kouba
 */
public class WildFly8DeploymentExceptionTransformer
    implements DeploymentExceptionTransformer {
  ...
  private static final String[] DEFINITION_EXCEPTION_FRAGMENTS =
      new String[] {"org.jboss.weld.exceptions.DefinitionException"};

  private static final String[] ISE_EXCEPTION_FRAGMENTS =
      new String[] {"org.jboss.weld.exceptions.IllegalStateException"};
  ...
  public Throwable transform(Throwable throwable) {
    ...
    if (root instanceof DeploymentException ||
        root instanceof DefinitionException ||

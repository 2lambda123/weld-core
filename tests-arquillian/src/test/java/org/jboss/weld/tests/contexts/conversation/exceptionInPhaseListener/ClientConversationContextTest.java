...
public class ClientConversationContextTest {
  ...
  public static WebArchive createDeployment() {
    return ShrinkWrap
        ...
        .addAsWebResource(ClientConversationContextTest.class.getPackage(),
                          "thunderstorm.jsf", "thunderstorm.jspx")
  ...
  public void testExceptionPhaseListener() throws Exception {
    ...
    getFirstMatchingElement(cloud, HtmlSubmitInput.class, "thunderstorm")
        .click();
  ...
  protected String getPath(String viewId) { return url + viewId; }

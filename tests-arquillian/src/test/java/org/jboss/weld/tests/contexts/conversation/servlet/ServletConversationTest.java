...
public class ServletConversationTest {
  ...
  public static WebArchive getDeployment() {
    return ShrinkWrap
        .create(WebArchive.class,
                Utils.getDeploymentNameAsHash(ServletConversationTest.class,
                                              Utils.ARCHIVE_TYPE.WAR))
        .addClasses(Message.class, Servlet.class,
                    DestroyedConversationObserver.class)
        .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml")
        .addAsWebResource(ServletConversationTest.class.getPackage(),
  ...
  public void testPost() throws Exception {
    ...
    // submit a form
    {
      ...
      getFirstMatchingElement(form, HtmlTextInput.class, "message")
          .setValueAttribute("Hola!");
      getFirstMatchingElement(form, HtmlTextInput.class, "cid")
          .setValueAttribute(cid);
      TextPage page =
          getFirstMatchingElement(form, HtmlSubmitInput.class, "submit")
              .click();
  ...
  public void testRedirect() throws Exception {
    ...
    // Do a redirect. Verify that the conversation is not propagated (In this
  ...
  public void testInvalidatingSessionDestroysConversation() throws Exception {
    ...
    /*
     * Invalidate the session. This should destroy the currently associated
     * conversation (with cid1) as well as the not-currently-associated
     * conversation (with cid2).
     */
    ...
    {
      TextPage page = client.getPage(
          getPath("/listConversationsDestroyedWhileBeingAssociated", null));
      assertTrue(page.getContent().contains(
          "ConversationsDestroyedWhileBeingAssociated:"));
      assertTrue(page.getContent().contains("<" + cid1 + ">"));
    }
    {
      TextPage page = client.getPage(
          getPath("/listConversationsDestroyedWhileBeingDisassociated", null));
      assertTrue(page.getContent().contains(
          "ConversationsDestroyedWhileBeingDisassociated:"));
  ...
  protected String getCid(String content) {
    return content.substring(content.indexOf("cid: [") + 6,
                             content.indexOf("]"));
  }
